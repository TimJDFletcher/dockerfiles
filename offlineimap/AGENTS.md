...
| Component | Value |
|-----------|-------|
| Base Image | `debian:trixie-20260918-slim` |
| Packages | `offlineimap`, `ca-certificates`, `curl`, `procps` |
| Scheduler | `supercronic` v0.2.49 (downloaded from GitHub) |

## Build Args

| Arg | Default | Description |
|-----|---------|-------------|
| `DEBIAN_VERSION` | `trixie-20260918-slim` | Debian base image tag |
| `SUPERCRONIC_VERSION` | `v0.2.49` | Supercronic release version |
