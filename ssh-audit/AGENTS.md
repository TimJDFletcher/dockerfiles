...
Tests run in two phases. Before testing, the pinned official goss binary is extracted from `ghcr.io/goss-org/goss` into `.goss-bin/` and bind-mounted into the container:
